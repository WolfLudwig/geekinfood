 ...
 */
final class Version20191003102059 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, name, image, cookingtime FROM recipe');
        ...
        $this->addSql('INSERT INTO recipe (id, name, image, cookingtime) SELECT id, name, image, cookingtime FROM __temp__recipe');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, name, image, cookingtime FROM recipe');
        $this->addSql('DROP TABLE recipe');
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, cookingtime INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO recipe (id, name, image, cookingtime) SELECT id, name, image, cookingtime FROM __temp__recipe');
        $this->addSql('DROP TABLE __temp__recipe');
    }
}
